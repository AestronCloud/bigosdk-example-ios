...
#import "CSDropdownListView.h"
@implementation CSDropdownListItem
...
@interface CSDropdownListView()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UILabel *textLabel;
@property (nonatomic, strong) UIImageView *arrowImg;
@property (nonatomic, strong) UITableView *tbView;
@property (nonatomic, strong) UIView *backgroundView;
@property (nonatomic, copy) CSDropdownListViewSelectedBlock selectedBlock;
@end
...
@implementation CSDropdownListView
...
- (void)selectedItemAtIndex:(NSInteger)index {
    ...
    if (index < _dataSource.count) {
        CSDropdownListItem *item = _dataSource[index];
        _selectedItem = item;
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    CSDropdownListItem *item = _dataSource[indexPath.row];
